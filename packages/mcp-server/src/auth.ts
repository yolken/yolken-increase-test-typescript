...
const apiKey = Array.isArray(req.headers['x-yolken-increase-test-api-key']) ? req.headers['x-yolken-increase-test-api-key'][0] : req.headers['x-yolken-increase-test-api-key']
return {apiKey}; }
