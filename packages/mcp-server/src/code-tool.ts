...
const remoteStainlessHandler = async ({
  ...
  const localClientEnvs = {
    YOLKEN_INCREASE_TEST_API_KEY: requireValue(
      readEnv('YOLKEN_INCREASE_TEST_API_KEY') ?? client.apiKey,
      'set YOLKEN_INCREASE_TEST_API_KEY environment variable or provide apiKey client option',
    ),
    YOLKEN_INCREASE_TEST_BASE_URL:
      readEnv('YOLKEN_INCREASE_TEST_BASE_URL') ?? readEnv('YOLKEN_INCREASE_TEST_ENVIRONMENT') ?
        undefined
