...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: YolkenIncreaseTest): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: YolkenIncreaseTest): Logger {
