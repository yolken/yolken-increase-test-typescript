...
export class ACHPrenotifications extends APIResource {
   ...
   * @example
   * ```ts
   * const achPrenotifications =
   *   await client.achPrenotifications.list();
   * ```
   */
  list(query: ACHPrenotificationListParams | null | undefined = {}, options?: RequestOptions): APIPromise<ACHPrenotificationListResponse> {
    return this._client.get('/ach_prenotifications', { query, ...options });
  }
}
 ...
 */
export interface ACHPrenotificationListResponse {
  /**
   * The contents of the list.
   */
  data: Array<ACHPrenotification>;
...
export interface ACHPrenotificationListParams {
