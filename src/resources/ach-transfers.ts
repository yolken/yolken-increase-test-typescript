...
export class ACHTransfers extends APIResource {
   ...
   * @example
   * ```ts
   * const achTransfers = await client.achTransfers.list();
   * ```
   */
  list(query: ACHTransferListParams | null | undefined = {}, options?: RequestOptions): APIPromise<ACHTransferListResponse> {
    return this._client.get('/ach_transfers', { query, ...options });
  }
...
export interface ACHTransfer {
   ...
   */
  inbound_funds_hold: InboundFundsHold | null;
...
export interface ACHTransferListParams {
  /**
