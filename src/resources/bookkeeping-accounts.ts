...
export class BookkeepingAccounts extends APIResource {
   ...
   * ```ts
   * const response =
   *   await client.bookkeepingAccounts.retrieveBalance(
   *     'bookkeeping_account_e37p1f1iuocw5intf35v',
   *   );
   * ```
   */
 ...
 * point in time.
 */
export interface BookkeepingAccountRetrieveBalanceResponse {
  /**
...
export interface BookkeepingAccountListParams {
  /**
...
export interface BookkeepingAccountRetrieveBalanceParams {
  /**
