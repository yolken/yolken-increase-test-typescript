 ...
 */
export interface BookkeepingEntrySetListResponse {
  /**
   * The contents of the list.
   */
  data: Array<BookkeepingEntrySet>;
...
export interface BookkeepingEntrySetListParams {
  /**
