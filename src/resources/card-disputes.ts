...
export class CardDisputes extends APIResource {
   ...
   * @example
   * ```ts
   * const cardDisputes = await client.cardDisputes.list();
   * ```
   */
  list(query: CardDisputeListParams | null | undefined = {}, options?: RequestOptions): APIPromise<CardDisputeListResponse> {
    return this._client.get('/card_disputes', { query, ...options });
  }
...
export namespace CardDispute {
  ...
  export namespace Visa {
    export interface NetworkEvent {
       ...
       */
      attachment_files: Array<CardDisputesAPI.CardDisputeFileAttachment>;
...
export interface CardDisputeFileAttachment {
  /**
 ...
 */
export interface CardDisputeListResponse {
  /**
   * The contents of the list.
   */
  data: Array<CardDispute>;
...
export interface CardDisputeListParams {
