...
export class Cards extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.cards.createDetailsIframe(
   *   'card_oubs0hwk5rn6knuecxg2',
   * );
   * ```
   */
   ...
   * @example
   * ```ts
   * const cardDetails = await client.cards.retrieveDetails(
   *   'card_oubs0hwk5rn6knuecxg2',
   * );
   * ```
   */
  retrieveDetails(cardID: string, options?: RequestOptions): APIPromise<CardDetails> {
 ...
 */
export interface CardCreateDetailsIframeResponse {
  /**
