...
import * as EntitySupplementalDocumentsAPI from './entity-supplemental-documents';
...
export interface Entity {
   ...
   */
  supplemental_documents: Array<EntitySupplementalDocumentsAPI.EntitySupplementalDocument>;
...
export namespace Entity {
  ...
  export namespace Validation {
    export interface Issue {
       ...
       */
      entity_tax_identifier: unknown | null;
    }
