...
export class EventSubscriptions extends APIResource {
   ...
   * ```
   */
  list(query: EventSubscriptionListParams | null | undefined = {}, options?: RequestOptions): APIPromise<EventSubscriptionListResponse> {
    return this._client.get('/event_subscriptions', { query, ...options });
  }
}
...
export interface EventSubscriptionListParams {
  /**
