...
export class Groups extends APIResource {
   ...
   * @example
   * ```ts
   * const response = await client.groups.retrieveCurrent();
   * ```
   */
  retrieveCurrent(options?: RequestOptions): APIPromise<GroupRetrieveCurrentResponse> {
 ...
 */
export interface GroupRetrieveCurrentResponse {
  /**
