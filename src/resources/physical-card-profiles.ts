 ...
 */
export interface PhysicalCardProfileListResponse {
  /**
   * The contents of the list.
   */
  data: Array<PhysicalCardProfile>;
...
export interface PhysicalCardProfileListParams {
  /**
