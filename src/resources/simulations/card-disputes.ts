...
export class CardDisputes extends APIResource {
   ...
   * ```ts
   * const cardDispute =
   *   await client.simulations.cardDisputes.advanceState(
...
export interface CardDisputeAdvanceStateParams {
  /**
   ...
   */
  visa?: CardDisputeAdvanceStateParams.Visa;
}

export namespace CardDisputeAdvanceStateParams {
  /**
   * The Visa-specific parameters for the taking action on the dispute. Required if
   * and only if `network` is `visa`.
   */
