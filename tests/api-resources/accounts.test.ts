...
describe('resource accounts', () => {
  ...
  test.skip('retrieveBalance', async () => {
    const responsePromise = client.accounts.retrieveBalance('account_in71c4amph0vgo2qllky');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('retrieveIntrafiBalance', async () => {
    const responsePromise = client.accounts.retrieveIntrafiBalance('account_in71c4amph0vgo2qllky');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
