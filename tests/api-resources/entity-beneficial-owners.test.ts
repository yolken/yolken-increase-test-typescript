...
describe('resource entityBeneficialOwners', () => {
  ...
  test.skip('retrieve', async () => {
    const responsePromise = client.entityBeneficialOwners.retrieve(
  ...
  test.skip('update', async () => {
    const responsePromise = client.entityBeneficialOwners.update(
      'entity_beneficial_owner_vozma8szzu1sxezp5zq6',
      {},
    );
    const rawResponse = await responsePromise.asResponse();
  ...
  test.skip('archive', async () => {
    const responsePromise = client.entityBeneficialOwners.archive(
      'entity_beneficial_owner_vozma8szzu1sxezp5zq6',
    );
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
