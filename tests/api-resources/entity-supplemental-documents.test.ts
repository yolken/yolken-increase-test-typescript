...
describe('resource entitySupplementalDocuments', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.entitySupplementalDocuments.create({ entity_id: 'entity_n8y8tnk2p9339ti393yi', file_id: 'file_makxrc67oh9l6sg7w9yc' });
  ...
  test.skip('create: required and optional params', async () => {
    const response = await client.entitySupplementalDocuments.create({ entity_id: 'entity_n8y8tnk2p9339ti393yi', file_id: 'file_makxrc67oh9l6sg7w9yc' });
  });
