...
describe('resource cardAuthentications', () => {
  ...
  test.skip('createChallenge', async () => {
    const responsePromise = client.simulations.cardAuthentications.createChallenge('card_payment_nd3k2kacrqjli8482ave');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createChallengeAttempt: only required params', async () => {
    const responsePromise = client.simulations.cardAuthentications.createChallengeAttempt('card_payment_nd3k2kacrqjli8482ave', { one_time_code: '123456' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createChallengeAttempt: required and optional params', async () => {
    const response = await client.simulations.cardAuthentications.createChallengeAttempt('card_payment_nd3k2kacrqjli8482ave', { one_time_code: '123456' });
  });
});
