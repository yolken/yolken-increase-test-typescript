...
describe('resource simulations', () => {
  ...
  test.skip('confirmFuelAuthorization: only required params', async () => {
    const responsePromise = client.simulations.confirmFuelAuthorization({ amount: 5000, card_payment_id: 'card_payment_nd3k2kacrqjli8482ave' });
  ...
  test.skip('confirmFuelAuthorization: required and optional params', async () => {
    const response = await client.simulations.confirmFuelAuthorization({ amount: 5000, card_payment_id: 'card_payment_nd3k2kacrqjli8482ave' });
  });

  // Mock server tests are disabled
  test.skip('createAccountStatement: only required params', async () => {
    const responsePromise = client.simulations.createAccountStatement({ account_id: 'account_in71c4amph0vgo2qllky' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createAccountStatement: required and optional params', async () => {
    const response = await client.simulations.createAccountStatement({ account_id: 'account_in71c4amph0vgo2qllky' });
  });
  ...
  test.skip('createDigitalWalletTokenRequest: only required params', async () => {
    const responsePromise = client.simulations.createDigitalWalletTokenRequest({ card_id: 'card_oubs0hwk5rn6knuecxg2' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createDigitalWalletTokenRequest: required and optional params', async () => {
    const response = await client.simulations.createDigitalWalletTokenRequest({ card_id: 'card_oubs0hwk5rn6knuecxg2' });
  });

  // Mock server tests are disabled
  test.skip('createInboundACHTransfer: only required params', async () => {
    const responsePromise = client.simulations.createInboundACHTransfer({ account_number_id: 'account_number_v18nkfqm6afpsrvy82b2', amount: 1000 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createInboundFednowTransfer: only required params', async () => {
    const responsePromise = client.simulations.createInboundFednowTransfer({ account_number_id: 'account_number_v18nkfqm6afpsrvy82b2', amount: 1000 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createInboundMailItem: only required params', async () => {
    const responsePromise = client.simulations.createInboundMailItem({ amount: 1000, lockbox_id: 'lockbox_3xt21ok13q19advds4t5' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createInboundRealTimePaymentsTransfer: only required params', async () => {
    const responsePromise = client.simulations.createInboundRealTimePaymentsTransfer({ account_number_id: 'account_number_v18nkfqm6afpsrvy82b2', amount: 1000 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createInboundWireTransfer: only required params', async () => {
    const responsePromise = client.simulations.createInboundWireTransfer({ account_number_id: 'account_number_v18nkfqm6afpsrvy82b2', amount: 1000 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('createInterestPayment: only required params', async () => {
    const responsePromise = client.simulations.createInterestPayment({ account_id: 'account_in71c4amph0vgo2qllky', amount: 1000 });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('expireCardAuthorization: only required params', async () => {
    const responsePromise = client.simulations.expireCardAuthorization({ card_payment_id: 'card_payment_nd3k2kacrqjli8482ave' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('expireCardAuthorization: required and optional params', async () => {
    const response = await client.simulations.expireCardAuthorization({ card_payment_id: 'card_payment_nd3k2kacrqjli8482ave' });
  });
  ...
  test.skip('incrementCardAuthorization: only required params', async () => {
    const responsePromise = client.simulations.incrementCardAuthorization({ amount: 500, card_payment_id: 'card_payment_nd3k2kacrqjli8482ave' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('reverseCardAuthorization: only required params', async () => {
    const responsePromise = client.simulations.reverseCardAuthorization({ card_payment_id: 'card_payment_nd3k2kacrqjli8482ave' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('reverseCardAuthorization: required and optional params', async () => {
    const response = await client.simulations.reverseCardAuthorization({ card_payment_id: 'card_payment_nd3k2kacrqjli8482ave', amount: 1 });
  });

  // Mock server tests are disabled
  test.skip('settleCardAuthorization: only required params', async () => {
    const responsePromise = client.simulations.settleCardAuthorization({ card_id: 'card_oubs0hwk5rn6knuecxg2', pending_transaction_id: 'pending_transaction_k1sfetcau2qbvjbzgju4' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
